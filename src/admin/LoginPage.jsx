...
export function LoginPage({ onLogin, onBack }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[linear-gradient(135deg,#111827,#1f2937)] p-4">
      <form onSubmit={submit} className="w-full max-w-md rounded-2xl bg-white p-8 shadow-2xl">
        <div className="mb-6">
          ...
          <h1 className="mt-2 text-3xl font-semibold text-slate-900">欢迎回来</h1>
          <p className="mt-2 text-sm text-slate-500">请输入账户信息继续。</p>
        </div>
